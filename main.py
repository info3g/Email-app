...
def index():
    message = ''
    # timeline={'Owner':'Owner', 'Developer':'Developer', 'Engineer':'Engineer','Technical_Lead':'Technical_Lead'}
...
def logged_in():
    if "gmail" in session["email"]:
        ...
        #             return render_template('logged_in.html', datas = data)
        #         except Exception as e:
        #             return dumps({'error' : str(e)})
        #     else:
        #         try:
        #             data = db.register.find({"Role":"Member"})
